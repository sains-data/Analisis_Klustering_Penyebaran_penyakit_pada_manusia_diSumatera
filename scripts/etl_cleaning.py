...
df_raw = spark.read.parquet("hdfs://namenode:8020/data/silver/penyakit_cleaned")
...
df_pivot.write.mode("overwrite").parquet("hdfs://namenode:8020/data/silver/penyakit_vector")
